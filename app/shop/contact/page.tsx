      ...
      <section className="relative py-24 px-6 flex items-center justify-center overflow-hidden border-b border-gray-800">
        ...
        <div className="relative z-10 text-center max-w-3xl mx-auto">
          ...
          <p className="text-lg text-gray-400">
            Whether you are looking for a bespoke creation or need assistance
            with an existing order, our dedicated team is here to assist you
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-5 space-y-12">
            <div>
              <h2 className="text-3xl font-serif text-white mb-8 border-b border-gray-800 pb-4">
                Our Boutiques
              </h2>
          ...
          <div className="lg:col-span-7">
            <div className="bg-[#141414] p-8 md:p-12 rounded-2xl border border-gray-800 shadow-2xl relative overflow-hidden">
              ...
              <h2 className="text-2xl font-serif text-white mb-2 relative z-10">
                Send us a Message
              </h2>
              <p className="text-gray-400 mb-8 relative z-10">
                Our concierge will reply to your inquiry within 24 hours.
              </p>
