    ...
    <div className="min-h-screen bg-[#f8f5f2]">
      ...
      <section className="mx-auto max-w-7xl px-6 py-12">
        ...
        <div className="mb-10 flex flex-col items-start justify-between gap-4 md:flex-row md:items-center">
          <div>
            <h2 className="text-3xl font-bold text-[#2d2d2d]">All Products</h2>
              ...
              return (
                ...
                >
                  <div className="relative h-80 overflow-hidden bg-[#f3ece7]">
                    ...
                    <div className="absolute right-4 top-4 rounded-full bg-green-100 px-3 py-1 text-xs font-medium text-green-700">
                      {product.status}
                    </div>
                  </div>
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex gap-3">
                      ...
                      <button className="rounded-xl border border-[#ddd0c8] px-4 py-3 text-sm font-medium text-[#99775c] transition hover:bg-[#f3ece7]">
                        Wishlist
                      </button>
                    </div>
                  </div>
